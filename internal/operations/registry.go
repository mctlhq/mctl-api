...
var builtinOperations = []Operation{
	...
	},
	{
		...
		Parameters: []ParameterDef{
			...
			{Name: "quota_cpu_req", Type: "string", Default: "2", Description: "CPU request quota"},
			{Name: "quota_cpu_lim", Type: "string", Default: "4", Description: "CPU limit quota"},
			{Name: "quota_memory_req", Type: "string", Default: "3Gi", Description: "Memory request quota"},
			{Name: "quota_memory_lim", Type: "string", Default: "6Gi", Description: "Memory limit quota"},
