...
var recordedHints = map[string]hints{
	...
	"mctl_bind_agent_release":                 {readOnly: false, destructive: true, idempotent: false},
	...
	"mctl_request_lifecycle_reconcile":        {readOnly: false, destructive: false, idempotent: true},
	"mctl_fence_lifecycle_claim":              {readOnly: false, destructive: true, idempotent: false},
	"mctl_request_lifecycle_handoff":          {readOnly: false, destructive: true, idempotent: false},
	"mctl_retry_lifecycle_handoff":            {readOnly: false, destructive: false, idempotent: true},
	...
	"mctl_list_agents":                        {readOnly: true, destructive: false, idempotent: false},
	...
	"mctl_publish_agent_definition_version":   {readOnly: false, destructive: false, idempotent: false},
	"mctl_publish_agent_profile_version":      {readOnly: false, destructive: false, idempotent: false},
	...
	"mctl_rollback_agent_binding":             {readOnly: false, destructive: true, idempotent: false},
	...
	"mctl_set_agent_version_lifecycle":        {readOnly: false, destructive: true, idempotent: false},
