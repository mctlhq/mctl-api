...
func (h *Handlers) RequestLifecycleReconcile(w http.ResponseWriter, r *http.Request) {
	...
	result, err := h.opts.Lifecycle.RequestReconcile(lifecycleCaller(r), body.request(user.ID))
	if err != nil {
...
func (h *Handlers) FenceLifecycleClaim(w http.ResponseWriter, r *http.Request) {
	...
	result, err := h.opts.Lifecycle.FenceDeadClaim(lifecycleCaller(r), body.request(user.ID))
	if err != nil {
...
func (h *Handlers) RequestLifecycleHandoffRecovery(w http.ResponseWriter, r *http.Request) {
	...
	result, err := h.opts.Lifecycle.RequestHandoff(lifecycleCaller(r), body.request(user.ID), toOwner)
	if err != nil {
...
func (h *Handlers) RetryLifecycleHandoff(w http.ResponseWriter, r *http.Request) {
	...
	result, err := h.opts.Lifecycle.RetryHandoff(lifecycleCaller(r), body.request(user.ID))
	if err != nil {
