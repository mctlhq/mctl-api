...
| `EVENTS_VALKEY_URL` | `redis://user@host:port/db` of the platform Valkey, using the producer's ACL user. Needed together with `GITHUB_WEBHOOK_SECRET` and a database; otherwise the webhook answers 503. | — | No |
